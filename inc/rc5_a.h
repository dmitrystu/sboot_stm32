...
void _rc5_init(const uint8_t *key);
void _rc5_encrypt(uint32_t *out, const uint32_t *in, uint32_t blocks);
void _rc5_decrypt(uint32_t *out, const uint32_t *in, uint32_t blocks);
