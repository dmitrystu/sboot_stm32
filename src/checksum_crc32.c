...
#if (defined(DFU_VERIFY_CHECKSUM) && ( (DFU_VERIFY_CHECKSUM==CRC32FAST) || (DFU_VERIFY_CHECKSUM==CRC32SMALL)))
...
uint32_t checksum_create(void *data, uint32_t length)
{
    ...
    uint32_t *checksum_block = (uint32_t *) ((char *)data+length);
